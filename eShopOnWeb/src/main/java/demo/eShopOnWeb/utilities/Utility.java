package demo.eShopOnWeb.utilities;
...
public class Utility extends BasePage {
    ...
    //Author Sweta Oza
    //Utility Class contains methods to perform various operation
    ...
    /**
     * This method will scrolldown on element
     */
    public void scrollBottomToView(WebElement element) {
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        jse.executeScript("window.scrollBy(1200,2000)");
    }
    ...
    public void scrollUpToView(WebElement element) {
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        jse.executeScript("window.scrollBy(-350,-350)");
    }

    /**
     * This method will scrolldown on element
     */
    public void scrollBottomTovIew(By by) {
        JavascriptExecutor jse = (JavascriptExecutor) driver;
    ...
    /**
     * This method will click to element using javascriptExecutor
     */
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/demo/eShopOnWeb/screenshots/" + screenshotName + dateName + ".png";
